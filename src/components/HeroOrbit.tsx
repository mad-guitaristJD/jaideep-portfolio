...
export const HeroOrbit = ({ 
  children, size, rotation, shouldOrbit = false, orbitDuration, shouldSpin = false, spinDuration
} : PropsWithChildren<{
  size: number, rotation: number, shouldOrbit?:boolean, shouldSpin?:boolean, orbitDuration?:number, spinDuration?:number;
}>) => {
    return (
